...
cat >>/etc/hosts<<EOF
192.168.58.100   k8s58-master.example.com     k8s58-master  km1
192.168.58.101   k8s58-worker1.example.com    k8s58-worker1 kw1
192.168.58.102   k8s58-worker2.example.com    k8s58-worker2 kw2
192.168.58.103   k8s58-worker3.example.com    k8s58-worker3 kw3
192.168.58.104   k8s58-worker4.example.com    k8s58-worker4 kw4
EOF
